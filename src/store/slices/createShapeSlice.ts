...
export const createShapeSlice = (set, get) => ({
    addShape: (shapeType, options = {}) => {
        ...
        switch (shapeType) {
          case "rect":
            shape = new fabric.Rect({ width: 80, height: 80, fill: "transparent", stroke: "black", ...options });
            break;
          ...
          case "triangle":
            shape = new fabric.Triangle({ width: 100, height: 100, fill: "transparent", stroke: "black", ...options });
            break;

          case "line":
            shape = new fabric.Line([50, 50, 200, 50], { stroke: "black", strokeWidth: 2, selectable: true, hasControls: true, hasBorders: false, ...options });
            break;

          case "polygon":
          case "pentagon":
            shape = new fabric.Polygon(options.points || [{x:0,y:0},{x:50,y:0},{x:25,y:50}], { fill: "transparent", stroke: "black", ...options });
            break;
          ...
          case "star":
            shape = new fabric.Polygon(get().generateStarPoints(options.numPoints || 5, options.outerRadius || 50, options.innerRadius || 20), { fill: "transparent", stroke: "black", ...options });
            break;
