    ...
    return (
      <div className="p-3 border bg-gray-100 w-64">
        <div className="flex justify-between items-center mb-3">
          ...
          <button className="text-red-500 font-bold" onClick={closePanel}>✕</button>
        </div>

        <label className="block text-sm font-medium mb-2">Stroke</label>
        <input type="color" value={lineStroke} onChange={(e) => setLineStroke(e.target.value)} />
        ...
        <p className="text-xs text-gray-500 mt-3">Tip: Hold <kbd>Shift</kbd> to constrain to 0°, 45°, 90°.</p>
      </div>
    );
  }
